...
// intro = Du-Fassung, intro_sie = Sie-Fassung. Die Begrüßung ("Hallo …,") setzt
// IMMER der Mail-Renderer zentral — die Intros sind bewusst greeting-los und
// kleingeschrieben (Fortsetzung nach der Anrede).
export const TERMINE = {
  jour_fixe: {
    ...
    intro_sie: 'wie läuft alles bei Ihnen? Lassen Sie uns kurz den aktuellen Stand besprechen — 20-30 Minuten reichen, dann sind wir wieder auf einem Stand.',
  ...
  onboarding_abgeschlossen: {
    ...
    intro_sie: 'wir haben Ihr Onboarding fertig — lassen Sie uns kurz gemeinsam durchgehen, was passiert, damit Sie wissen, was als nächstes kommt.',
  ...
  entwuerfe: {
    ...
    intro_sie: 'Ihre Entwürfe sind fertig — statt Feedback nur schriftlich zu klären, gehen wir das gemeinsam kurz durch. Dauert ca. 20 Minuten.',
  ...
  go_live: {
    ...
    intro_sie: 'wir sind bereit für den Go-Live! Lassen Sie uns einen kurzen Termin machen, damit wir gemeinsam live schalten und Sie bei allen wichtigen Punkten dabei sind.',
  ...
  meta_einrichtung: {
    ...
    intro_sie: 'für die technische Meta-Einrichtung brauchen wir ca. 30 Minuten mit Ihnen gemeinsam. Bitte suchen Sie sich einen Termin aus:',
