...
export const EMAIL_TEMPLATE_CATALOG = [
  ...
  },
  {
    ...
    bereich: 'kampagne',
    betreffOnly: false,
    name: 'Kampagnen-Update (Update N)',
    beschreibung: 'An den Kunden: neue Werbeanzeigen während der Live-Phase (POST /jobs/:id/export/kampagne-update). {{runde}} = Update-Nummer. Der Body ist der Intro-Satz vor dem KI-Anschreiben.',
    platzhalter: ['runde', 'stelle'],
    betreff_du: 'Neue Werbeanzeigen für deine Kampagne — Update {{runde}} 📬',
    betreff_sie: 'Neue Werbeanzeigen für Ihre Kampagne — Update {{runde}} 📬',
    body_du: 'wir haben neue Werbeanzeigen für deine Kampagne erstellt, um die Performance weiter zu verbessern. Schau sie dir an und gib sie frei, damit wir sie live schalten können:',
    body_sie: 'wir haben neue Werbeanzeigen für Ihre Kampagne erstellt, um die Performance weiter zu verbessern. Sehen Sie sie sich an und geben Sie sie frei, damit wir sie live schalten können:',
  },
  {
    key: 'entwurf_neue_runde',
    bereich: 'kampagne',
    betreffOnly: false,
    name: 'Entwürfe — Folgerunde (Runde N)',
    beschreibung: 'An den Kunden: überarbeitete Entwürfe nach Feedback (POST /jobs/:id/export/email, Variante neue_runde). {{runde}} = Rundennummer. Body = Intro-Satz vor dem KI-Anschreiben. Hinweis: der Intro war im Code nur in Du-Form — die Sie-Fassung ist als Startwert identisch und kann hier angepasst werden.',
    platzhalter: ['runde', 'stelle'],
  ...
  },
  {
    ...
    bereich: 'kampagne',
    betreffOnly: false,
    name: 'Entwürfe — erneut gesendet',
    beschreibung: 'An den Kunden: dieselben Entwürfe nochmal (POST /jobs/:id/export/email, Variante resend). Betreff wie Erstversand; Body = kurzer Intro-Satz. Startwert der Sie-Fassung ist identisch zur Du-Fassung (im Code Du-only) und kann hier angepasst werden.',
    platzhalter: ['runde', 'stelle'],
    betreff_du: 'Deine Entwürfe sind fertig 🎨',
    betreff_sie: 'Ihre Entwürfe sind fertig 🎨',
  ...
  // ─────────────── Onboarding — Varianten ───────────────
  {
    key: 'upload_anfrage_logo',
    bereich: 'onboarding',
    betreffOnly: false,
    name: 'Fotos & Logo — Anfrage (nur Logo)',
    beschreibung: 'An den Kunden: nur das Logo hochladen (POST /kunden/:id/anfrage, umfang=logo). customText überschreibt den Body.',
    platzhalter: [],
    betreff_du: 'Wir brauchen noch euer Logo für die Kampagne',
    betreff_sie: 'Wir brauchen noch Ihr Logo für die Kampagne',
    body_du: 'wir bereiten gerade eure Recruiting-Kampagne vor und brauchen dafür noch euer Logo. Über den unten stehenden Link könnt ihr es ganz einfach hochladen.',
    body_sie: 'wir bereiten gerade Ihre Recruiting-Kampagne vor und brauchen dafür noch Ihr Logo. Über den unten stehenden Link können Sie es ganz einfach hochladen.',
  },
  {
    key: 'upload_anfrage_fotos',
    bereich: 'onboarding',
    betreffOnly: false,
    name: 'Fotos & Logo — Anfrage (nur Fotos)',
    beschreibung: 'An den Kunden: nur Fotos hochladen (POST /kunden/:id/anfrage, umfang=fotos). customText überschreibt den Body.',
    platzhalter: [],
    betreff_du: 'Wir brauchen noch ein paar Fotos für eure Kampagne',
    betreff_sie: 'Wir brauchen noch ein paar Fotos für Ihre Kampagne',
    body_du: 'wir bereiten gerade eure Recruiting-Kampagne vor und brauchen dafür noch ein paar Fotos vom Team / Arbeitsplatz. Über den unten stehenden Link könnt ihr sie ganz einfach hochladen.',
    body_sie: 'wir bereiten gerade Ihre Recruiting-Kampagne vor und brauchen dafür noch ein paar Fotos vom Team / Arbeitsplatz. Über den unten stehenden Link können Sie sie ganz einfach hochladen.',
  },
  {
    key: 'formular_einladung_neukunden',
    bereich: 'onboarding',
    betreffOnly: false,
    name: 'Briefing-Formular-Einladung (Neukundengewinnung)',
    beschreibung: 'An den Kunden: Briefing-Formular für Neukunden-Projekte (projekttyp=neukundengewinnung). customText überschreibt den Body. Aufzählung + Tipp bleiben im Code.',
    platzhalter: [],
    betreff_du: 'Kurzes Briefing-Formular für eure Neukunden-Kampagne',
    betreff_sie: 'Kurzes Briefing-Formular für Ihre Neukunden-Kampagne',
    body_du: 'wir freuen uns auf eure Neukunden-Kampagne! Damit wir starten können, haben wir ein kurzes Briefing-Formular für euch vorbereitet — dort tragt ihr alles rund um euer Angebot, eure Zielgruppe und euer Unternehmen ein. Dauert etwa 10 Minuten.',
    body_sie: 'wir freuen uns auf Ihre Neukunden-Kampagne! Damit wir starten können, haben wir ein kurzes Briefing-Formular für Sie vorbereitet — dort tragen Sie alles rund um Ihr Angebot, Ihre Zielgruppe und Ihr Unternehmen ein. Dauert etwa 10 Minuten.',
  },

  // ─────────────── Termine (nur Betreff — Body = customText) ───────────────
  {
    key: 'termin_jour_fixe',
    bereich: 'termine', betreffOnly: true,
    name: 'Termin — Jour Fixe (Betreff)',
    beschreibung: 'Betreff der Termin-Einladung „Jour Fixe" (termine.js). Der Body wird im Modal frei getippt (customText).',
    platzhalter: [],
    betreff_du: 'Kurzer Jour Fixe? 📅', betreff_sie: 'Kurzer Jour Fixe? 📅', body_du: null, body_sie: null,
  },
  {
    key: 'termin_onboarding_abgeschlossen',
    bereich: 'termine', betreffOnly: true,
    name: 'Termin — Onboarding-Abschluss (Betreff)',
    beschreibung: 'Betreff der Termin-Einladung „Onboarding-Abschluss" (termine.js). Body = customText.',
    platzhalter: [],
    betreff_du: 'Onboarding-Abschluss — kurzer Termin 📅', betreff_sie: 'Onboarding-Abschluss — kurzer Termin 📅', body_du: null, body_sie: null,
  },
  {
    key: 'termin_entwuerfe',
    bereich: 'termine', betreffOnly: true,
    name: 'Termin — Entwürfe besprechen (Betreff)',
    beschreibung: 'Betreff der Termin-Einladung „Entwürfe besprechen" (termine.js). Body = customText.',
    platzhalter: [],
    betreff_du: 'Lass uns deine Entwürfe besprechen 📅', betreff_sie: 'Lass uns deine Entwürfe besprechen 📅', body_du: null, body_sie: null,
  },
  {
    key: 'termin_go_live',
    bereich: 'termine', betreffOnly: true,
    name: 'Termin — Go-Live (Betreff)',
    beschreibung: 'Betreff der Termin-Einladung „Go-Live" (termine.js). Body = customText.',
    platzhalter: [],
    betreff_du: 'Dein Go-Live Termin 🚀', betreff_sie: 'Dein Go-Live Termin 🚀', body_du: null, body_sie: null,
  },
  {
    key: 'termin_meta_einrichtung',
    bereich: 'termine', betreffOnly: true,
    name: 'Termin — Meta-Einrichtung (Betreff)',
    beschreibung: 'Betreff der Termin-Einladung „Meta-Einrichtung" (termine.js). Body = customText.',
    platzhalter: [],
    betreff_du: 'Termin Meta-Einrichtung 📅', betreff_sie: 'Termin Meta-Einrichtung 📅', body_du: null, body_sie: null,
  },

  // ─────────────── Rechnung & Zahlung ───────────────
  {
    key: 'zahlung_paypal',
    bereich: 'rechnung', betreffOnly: true,
    name: 'PayPal-Zahlungslink (Betreff)',
    beschreibung: 'An den Kunden: Werbebudget-Rechnung mit PayPal-Zahlungslink (POST /zahlungen/:id/send). Nur der Betreff ist editierbar; Betrag/Tabelle/Button entstehen im Code.',
    platzhalter: ['stelle'],
    betreff_du: 'Rechnung Werbebudget — {{stelle}}', betreff_sie: 'Rechnung Werbebudget — {{stelle}}', body_du: null, body_sie: null,
  },
  {
    key: 'rechnung_pdf_paypal',
    bereich: 'rechnung', betreffOnly: false,
    name: 'PayPal-Rechnung (PDF-Anhang)',
    beschreibung: 'An den Kunden: Rechnung als PDF nach Zahlung (POST /zahlungen/:id/rechnung/send).',
    platzhalter: ['rechnungsnr', 'firma'],
    betreff_du: 'Rechnung {{rechnungsnr}} — {{firma}}',
    betreff_sie: 'Rechnung {{rechnungsnr}} — {{firma}}',
    body_du: 'Vielen Dank für eure Zahlung! Anbei erhaltet ihr eure Rechnung als PDF im Anhang.',
    body_sie: 'Vielen Dank für Ihre Zahlung! Anbei erhalten Sie Ihre Rechnung als PDF im Anhang.',
  },

  // ─────────────── Verwaltung — Benachrichtigungen an den Kunden ───────────────
  {
    key: 'bewerber_benachrichtigung',
    bereich: 'verwaltung', betreffOnly: true,
    name: 'Neue Bewerbung — Benachrichtigung (Betreff)',
    beschreibung: 'An den Kunden: neue Bewerbung eingegangen (Perspective-/Funnel-Webhook). Nur der Betreff ist editierbar; Kontakt-/Antwort-Tabelle entsteht im Code.',
    platzhalter: ['stelle', 'name_suffix'],
    betreff_du: 'Neue Bewerbung für {{stelle}}{{name_suffix}}', betreff_sie: 'Neue Bewerbung für {{stelle}}{{name_suffix}}', body_du: null, body_sie: null,
  },
  {
    key: 'anfrage_lead',
    bereich: 'verwaltung', betreffOnly: true,
    name: 'Neue Anfrage/Lead — Benachrichtigung (Betreff)',
    beschreibung: 'An den Kunden: neue Anfrage über die Landingpage (POST /webhooks/leads). Nur der Betreff ist editierbar; Daten-Tabelle entsteht im Code.',
    platzhalter: ['produkt', 'name'],
    betreff_du: '🎉 Neue Anfrage für {{produkt}}: {{name}}', betreff_sie: '🎉 Neue Anfrage für {{produkt}}: {{name}}', body_du: null, body_sie: null,
  },
];
...
export function demoDatenFor(key, kunde, form) {
  ...
  return {
    ...
    firma,
    produkt: 'Wärmepumpen-Beratung',
    name: 'Max Mustermann',
    name_suffix: ' — Max Mustermann',
  };
}
