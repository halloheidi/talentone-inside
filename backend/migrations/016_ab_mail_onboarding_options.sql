-- Migration 016: AB-Mail-Template — „So geht es weiter"-Satz und Setup-
-- Rechnungs-Satz auf zwei Absätze aufteilen, damit das Send-Modal nur den
-- ersten manipulieren kann (Onboarding-Termin-Toggle, Formular-Option).
-- Zusätzlich neuer Template-Key `onboarding_form_url` je Marke (leer,
-- Admin-UI-editierbar).
