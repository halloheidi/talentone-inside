-- Migration 006: "Einrichtung weiteres Stellenprofil" je Marke als eigene
-- Setup-Position. Wird über den bestehenden Extra-Stellen-Zähler gekoppelt
-- mit der monatlichen "Weitere parallele Stellenkampagne"-Position gesteuert
-- (Wizard-Logik, nicht DB). Beide Positionen laufen mit derselben quantity.
