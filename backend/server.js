...
import bestandskundenRouter from './routes/bestandskunden.js';
...
import { startBestandskundenScheduler } from './bestandskunden-sync.js';
...
app.use('/api/suche', requireAuth, sucheRouter);
...
app.use('/api/bestandskunden', requireAuth, requireAdmin, bestandskundenRouter);
