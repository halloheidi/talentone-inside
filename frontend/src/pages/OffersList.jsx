    ...
    <div>
      ...
      {newDraftId && (
        <div style={{ padding: 14, background: 'color-mix(in srgb, var(--accent) 12%, #fff)', border: '1px solid var(--accent)', borderRadius: 10, marginBottom: 14, fontSize: 13 }}>
          ✓ Entwurf gespeichert. Die easybill-Erzeugung folgt in Phase 3.
        </div>
      )}
          ...
          <table className="bewerbungen-table">
            ...
            <tbody>
              {offers.map(o => {
                ...
                return (
                  <tr key={o.id} style={{ background: newDraftId === o.id ? 'color-mix(in srgb, var(--accent) 8%, transparent)' : undefined }}>
