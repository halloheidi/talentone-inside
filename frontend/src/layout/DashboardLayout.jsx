    ...
    <nav className="nav">
      ...
      {isAdmin && (
        <>
          ...
          <NavLink to="/admin/email-vorlagen" className={({ isActive }) => `nav-item ${isActive ? 'is-active' : ''}`}>
            <Icon name="users" />
          ...
          <NavLink to="/bestandskunden" className={({ isActive }) => `nav-item ${isActive ? 'is-active' : ''}`}>
            <Icon name="users" />
